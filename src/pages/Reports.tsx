...
const Reports = () => {
  ...
  return (
    <div className="container mx-auto py-6">
      <h1 className="text-2xl font-bold mb-6">Générer des rapports</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="col-span-1">
          <CardHeader>
            <CardTitle>Rapports d'entretien</CardTitle>
            <CardDescription>Générer des rapports à partir des données de maintenance</CardDescription>
          </CardHeader>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {date ? format(date, "PPP", { locale: fr }) : "Choisissez une date"}
                  </Button>
                </PopoverTrigger>
